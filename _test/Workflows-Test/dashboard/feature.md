...
| Guideline | Source |
|---|---|
| Max content width 960px; `spacing(3)` padding (XS: `spacing(2)`) | CONFIRM: `workflows/config/_guidelines.md` (stub) |
...
3. `workflows/config/_guidelines.md` and `global/_guidelines.md` are stubs — product layout rules (max-width, column behavior) inferred from Figma annotations only.
